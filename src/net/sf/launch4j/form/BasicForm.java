...
public abstract class BasicForm extends JPanel
{
   ...
   public JPanel createPanel()
   {
      ...
      jpanel1.add(_processPriorityLabel,cc.xy(2,18));
      ...
      jpanel1.add(_normalPriorityRadio,cc.xy(4,18));
      ...
      jpanel1.add(_idlePriorityRadio,cc.xy(6,18));
      ...
      jpanel1.add(_highPriorityRadio,cc.xy(8,18));
